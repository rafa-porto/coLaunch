        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div>
              ...
              <p className="text-xl text-[#7a7a7a] mb-4">{product.tagline}</p>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#7a7a7a]">
                    Por <Link href={`/users/${product.user.id}`} className="text-[#b17f01] hover:underline">{product.user.name}</Link>
                  </span>
                </div>
          ...
          <div className="space-y-6">
            {/* Card de upvote */}
            <Card className="bg-[#2a2a2a] border-[#424242]">
              <CardHeader>
                <CardTitle className="text-white text-center">
                  <span className="text-3xl">{product.upvoteCount}</span>
                  <span className="block text-sm text-[#7a7a7a]">upvotes</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <UpvoteButton 
            ...
            <Card className="bg-[#2a2a2a] border-[#424242]">
              ...
              <CardContent className="space-y-4">
                {product.websiteUrl && (
                  <Button asChild variant="outline" className="w-full border-[#424242] text-[#7a7a7a]">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {product.tags.map((tag) => (
                      <span 
                        key={tag.id}
                        className="px-2 py-1 bg-[#424242] text-[#7a7a7a] rounded-md text-sm"
                      >
                        {tag.name}
                      </span>
                    ))}
